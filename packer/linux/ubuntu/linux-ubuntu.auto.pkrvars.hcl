...
iso_paths_01                          = ["[PURE-Vol04] ATDUONG-ISO/ubuntu-20.04.6-live-server-amd64.iso"]
iso_paths_02                          = ["[PURE-Vol04] ATDUONG-ISO/ubuntu-22.04.5-live-server-amd64.iso"]
iso_paths_03                          = ["[PURE-Vol04] ATDUONG-ISO/ubuntu-24.04.2-live-server-amd64.iso"]
